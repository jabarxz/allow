...
vlesslink15="vless://${uuid}@api-faceid.maxis.com.my.${domain}:$tls?path=/nevermore-vlesswstls&host=${domain}&security=tls&encryption=none&type=ws&sni=www.mosti.gov.my#${user}"
